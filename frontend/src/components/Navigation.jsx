        ...
        <div className="flex items-center justify-between h-20">
          ...
          <motion.a
            ...
            <div className="flex flex-col">
              <span className="font-bold text-white text-xl tracking-tight leading-none">MAKEVERY

              </span>
              <span className="text-[11px] text-[#666] tracking-[0.15em]">BY MAKERISE INNOVATIONS
